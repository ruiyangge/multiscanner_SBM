...
for i = 1:10
    ...
    for j = 1:nT_all(i) 
        ...
        name(j,:) = ['D:\SBM_simulation\data_simTB\20200711\simData\sim_',sprintf('%02d',i),'\SimData_subject_001_DATA.nii,',sprintf('%03d',j)];
    
    end
    input_data_file_patterns = [input_data_file_patterns;name];
    clear name;
end
...
outputDir = 'D:\SBM_simulation\data_simTB\20200711\ICA_strategy2';
