...
%% Input data file pattern for data-sets must be in a cell array.
input_data_file_patterns = {'J:\RG_backup\SBM_simulation\SCZ_twoscanners\test\testData\dataset1\s*.nii';...
    'J:\RG_backup\SBM_simulation\SCZ_twoscanners\test\testData\dataset2\s*.nii'};
...
outputDir = 'J:\RG_backup\SBM_simulation\SCZ_twoscanners\test';
...
maskFile = ['J:\RG_backup\SBM_simulation\SCZ_twoscanners\icaMask.nii'];
