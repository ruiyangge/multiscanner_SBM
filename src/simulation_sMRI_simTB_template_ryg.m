function sP = simulation_sMRI_simTB_template_ryg(nT,D_CNR,out_path,nV,SM_source_ID,verbose_display)
%-------------------------------------------------------------------------------
...
sP.SM_translate_x = 0.0*randn(M,nC);  % Translation in x, mean 0, SD 1 voxels.
sP.SM_translate_y = 0.0*randn(M,nC);  % Translation in y, mean 0, SD 1 voxels.
sP.SM_theta       = 0.0*randn(M,nC);  % Rotation, mean 0, SD 1 degree.
